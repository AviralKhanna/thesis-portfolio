export const sources = [
  ...
  { id: "intro", title: "Introduction", kind: "course notes", file: "Finance Notes/Level-0 Introduction.pdf", status: "available", scope: "Not yet reviewed", addedAt: "2026-08-03" },
  { id: "technical", title: "Technical Analysis", kind: "course notes", file: "Finance Notes/Level-2 Technical Analysis.pdf", status: "available", scope: "Trading; intentionally excluded from core philosophy", addedAt: "2026-08-03" },
  { id: "futures", title: "Future Trading", kind: "course notes", file: "Finance Notes/Level-3 Future Trading.pdf", status: "available", scope: "Not yet reviewed", addedAt: "2026-08-03" },
  { id: "options", title: "Option Trading", kind: "course notes", file: "Finance Notes/Level-4 Option Trading.pdf", status: "available", scope: "Not yet reviewed", addedAt: "2026-08-03" },
  { id: "strategies", title: "Options Strategy", kind: "course notes", file: "Finance Notes/Level-5 Options Strategy.pdf", status: "available", scope: "Not yet reviewed", addedAt: "2026-08-03" },
  { id: "mutual-funds", title: "Mutual Funds", kind: "course notes", file: "Finance Notes/Level-6 Mutual Funds.pdf", status: "available", scope: "Not yet reviewed", addedAt: "2026-08-03" },
  { id: "finance", title: "Finance", kind: "course notes", file: "Finance Notes/Level-7 Finance.pdf", status: "available", scope: "Not yet reviewed", addedAt: "2026-08-03" }
];
